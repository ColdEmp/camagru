...
<html lang="en">
	...
	<body>
		...
		<div class="page-container">
			...
			<section class="section is-centered content-wrap">
				<div class="columns">
					<div class="column"></div>
						<div class="column">
							<div style = "padding : 0px 0px 20px 0px">
								<div class="box has-text-centered has-background-grey-dark">
								<h1 class="title is-3 has-text-light">New Email</h1>
								<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
									...
									<div>
										<button class="button" name = "change" value = "change">Change Email</button>
									</div>
								</form>
							</div>
						</div>
